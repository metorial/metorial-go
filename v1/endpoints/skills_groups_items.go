...
func (e *SkillsGroupsItemsEndpoint) List(skillGroupId string, params *SkillsGroupsItemsEndpointListParams) (*items.SkillsGroupsItemsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"skill-groups", skillGroupId, "items"},
		Query: query,
	}
...
func (e *SkillsGroupsItemsEndpoint) Get(skillGroupId string, skillGroupItemId string) (*items.SkillsGroupsItemsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"skill-groups", skillGroupId, "items", skillGroupItemId},
	}
...
func (e *SkillsGroupsItemsEndpoint) Create(skillGroupId string, body *SkillsGroupsItemsEndpointCreateBody) (*items.SkillsGroupsItemsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"skill-groups", skillGroupId, "items"},
		Body: body,
	}
...
func (e *SkillsGroupsItemsEndpoint) Delete(skillGroupId string, skillGroupItemId string) (*items.SkillsGroupsItemsDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"skill-groups", skillGroupId, "items", skillGroupItemId},
	}
