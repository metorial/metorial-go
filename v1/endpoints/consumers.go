...
func (e *ConsumersEndpoint) GetMemberConsumer(body *ConsumersEndpointGetMemberConsumerBody) (*consumers.ConsumersGetMemberConsumerOutput, error) {
	req := &endpoint.Request{
		Path: []string{"get-member-consumer"},
		Body: body,
	}
