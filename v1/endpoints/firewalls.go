...
func (e *FirewallsEndpoint) List(params *FirewallsEndpointListParams) (*firewalls.FirewallsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"firewalls"},
		Query: query,
	}
...
func (e *FirewallsEndpoint) Get(firewallId string) (*firewalls.FirewallsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"firewalls", firewallId},
	}
...
func (e *FirewallsEndpoint) Create(body *FirewallsEndpointCreateBody) (*firewalls.FirewallsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"firewalls"},
		Body: body,
	}
...
func (e *FirewallsEndpoint) Update(firewallId string, body *FirewallsEndpointUpdateBody) (*firewalls.FirewallsUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"firewalls", firewallId},
		Body: body,
	}
...
func (e *FirewallsEndpoint) Delete(firewallId string) (*firewalls.FirewallsDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"firewalls", firewallId},
	}
