...
func (e *CustomProvidersEndpoint) GetEnv(customProviderId string) (*customproviders.CustomProvidersGetEnvOutput, error) {
	req := &endpoint.Request{
		Path: []string{"custom-providers", customProviderId, "env"},
	}
