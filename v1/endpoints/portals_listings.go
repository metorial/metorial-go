...
func (e *PortalsListingsEndpoint) List(portalId string, params *PortalsListingsEndpointListParams) (*listings.PortalsListingsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"portals", portalId, "listings"},
		Query: query,
	}
...
func (e *PortalsListingsEndpoint) Get(portalId string, listingId string) (*listings.PortalsListingsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"portals", portalId, "listings", listingId},
	}
...
func (e *PortalsListingsEndpoint) Create(portalId string, body *PortalsListingsEndpointCreateBody) (*listings.PortalsListingsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"portals", portalId, "listings"},
		Body: body,
	}
...
func (e *PortalsListingsEndpoint) Update(portalId string, listingId string, body *PortalsListingsEndpointUpdateBody) (*listings.PortalsListingsUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"portals", portalId, "listings", listingId},
		Body: body,
	}
...
func (e *PortalsListingsEndpoint) Delete(portalId string, listingId string) (*listings.PortalsListingsDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"portals", portalId, "listings", listingId},
	}
