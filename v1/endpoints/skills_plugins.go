...
func (e *SkillsPluginsEndpoint) List(params *SkillsPluginsEndpointListParams) (*plugins.SkillsPluginsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"skill-plugins"},
		Query: query,
	}
...
func (e *SkillsPluginsEndpoint) Get(skillPluginId string) (*plugins.SkillsPluginsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"skill-plugins", skillPluginId},
	}
...
func (e *SkillsPluginsEndpoint) Create(body *SkillsPluginsEndpointCreateBody) (*plugins.SkillsPluginsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"skill-plugins"},
		Body: body,
	}
...
func (e *SkillsPluginsEndpoint) Update(skillPluginId string, body *SkillsPluginsEndpointUpdateBody) (*plugins.SkillsPluginsUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"skill-plugins", skillPluginId},
		Body: body,
	}
...
func (e *SkillsPluginsEndpoint) Archive(skillPluginId string) (*plugins.SkillsPluginsArchiveOutput, error) {
	req := &endpoint.Request{
		Path: []string{"skill-plugins", skillPluginId},
	}
...
func (e *SkillsPluginsEndpoint) Sync(skillPluginId string) (*plugins.SkillsPluginsSyncOutput, error) {
	req := &endpoint.Request{
		Path: []string{"skill-plugins", skillPluginId, "sync"},
	}
