...
func (e *NetworksEndpoint) List(params *NetworksEndpointListParams) (*networks.NetworksListOutput, error) {
...
func (e *NetworksEndpoint) Get(networkId string) (*networks.NetworksGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"networks", networkId},
	}
...
func (e *NetworksEndpoint) ListNetworkLogs(params *NetworksEndpointListNetworkLogsParams) (*networks.NetworksListNetworkLogsOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"network-logs"},
		Query: query,
	}
