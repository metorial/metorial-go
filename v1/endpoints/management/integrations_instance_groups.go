...
func (e *IntegrationsInstanceGroupsEndpoint) List(instanceId string, params *IntegrationsInstanceGroupsEndpointListParams) (*instancegroups.IntegrationsInstanceGroupsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "integration-instance-groups"},
		Query: query,
	}
...
func (e *IntegrationsInstanceGroupsEndpoint) Get(instanceId string, integrationInstanceGroupId string) (*instancegroups.IntegrationsInstanceGroupsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instance-groups", integrationInstanceGroupId},
	}
...
func (e *IntegrationsInstanceGroupsEndpoint) CreateSessionTemplate(instanceId string, integrationInstanceGroupId string, body *IntegrationsInstanceGroupsEndpointCreateSessionTemplateBody) (*instancegroups.IntegrationsInstanceGroupsCreateSessionTemplateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instance-groups", integrationInstanceGroupId, "session-template"},
		Body: body,
	}
...
func (e *IntegrationsInstanceGroupsEndpoint) CreateSession(instanceId string, integrationInstanceGroupId string, body *IntegrationsInstanceGroupsEndpointCreateSessionBody) (*instancegroups.IntegrationsInstanceGroupsCreateSessionOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instance-groups", integrationInstanceGroupId, "session"},
		Body: body,
	}
...
func (e *IntegrationsInstanceGroupsEndpoint) Create(instanceId string, body *IntegrationsInstanceGroupsEndpointCreateBody) (*instancegroups.IntegrationsInstanceGroupsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instance-groups"},
		Body: body,
	}
...
func (e *IntegrationsInstanceGroupsEndpoint) Update(instanceId string, integrationInstanceGroupId string, body *IntegrationsInstanceGroupsEndpointUpdateBody) (*instancegroups.IntegrationsInstanceGroupsUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instance-groups", integrationInstanceGroupId},
		Body: body,
	}
...
func (e *IntegrationsInstanceGroupsEndpoint) Delete(instanceId string, integrationInstanceGroupId string) (*instancegroups.IntegrationsInstanceGroupsDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instance-groups", integrationInstanceGroupId},
	}
