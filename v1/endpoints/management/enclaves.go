...
func (e *EnclavesEndpoint) List(instanceId string, params *EnclavesEndpointListParams) (*enclaves.EnclavesListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "enclaves"},
		Query: query,
	}
...
func (e *EnclavesEndpoint) Get(instanceId string, enclaveId string) (*enclaves.EnclavesGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "enclaves", enclaveId},
	}
