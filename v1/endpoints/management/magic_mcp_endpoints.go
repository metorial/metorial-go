...
func (e *MagicMcpEndpointsEndpoint) List(instanceId string, params *MagicMcpEndpointsEndpointListParams) (*magicmcpendpoints.MagicMcpEndpointsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "magic-mcp-endpoints"},
		Query: query,
	}
...
func (e *MagicMcpEndpointsEndpoint) Get(instanceId string, magicMcpEndpointId string) (*magicmcpendpoints.MagicMcpEndpointsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "magic-mcp-endpoints", magicMcpEndpointId},
	}
...
func (e *MagicMcpEndpointsEndpoint) Create(instanceId string, body *MagicMcpEndpointsEndpointCreateBody) (*magicmcpendpoints.MagicMcpEndpointsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "magic-mcp-endpoints"},
		Body: body,
	}
...
func (e *MagicMcpEndpointsEndpoint) Delete(instanceId string, magicMcpEndpointId string) (*magicmcpendpoints.MagicMcpEndpointsDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "magic-mcp-endpoints", magicMcpEndpointId},
	}
...
func (e *MagicMcpEndpointsEndpoint) Update(instanceId string, magicMcpEndpointId string, body *MagicMcpEndpointsEndpointUpdateBody) (*magicmcpendpoints.MagicMcpEndpointsUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "magic-mcp-endpoints", magicMcpEndpointId},
		Body: body,
	}
...
func (e *MagicMcpEndpointsEndpoint) AddServers(instanceId string, magicMcpEndpointId string, body *MagicMcpEndpointsEndpointAddServersBody) (*magicmcpendpoints.MagicMcpEndpointsAddServersOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "magic-mcp-endpoints", magicMcpEndpointId, "add-servers"},
		Body: body,
	}
...
func (e *MagicMcpEndpointsEndpoint) RemoveServers(instanceId string, magicMcpEndpointId string, body *MagicMcpEndpointsEndpointRemoveServersBody) (*magicmcpendpoints.MagicMcpEndpointsRemoveServersOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "magic-mcp-endpoints", magicMcpEndpointId, "remove-servers"},
		Body: body,
	}
