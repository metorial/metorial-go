...
func (e *IntegrationsEndpoint) List(instanceId string, params *IntegrationsEndpointListParams) (*integrations.IntegrationsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "integrations"},
		Query: query,
	}
...
func (e *IntegrationsEndpoint) Get(instanceId string, integrationId string) (*integrations.IntegrationsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integrations", integrationId},
	}
...
func (e *IntegrationsEndpoint) Create(instanceId string, body *IntegrationsEndpointCreateBody) (*integrations.IntegrationsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integrations"},
		Body: body,
	}
...
func (e *IntegrationsEndpoint) Update(instanceId string, integrationId string, body *IntegrationsEndpointUpdateBody) (*integrations.IntegrationsUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integrations", integrationId},
		Body: body,
	}
...
func (e *IntegrationsEndpoint) Delete(instanceId string, integrationId string) (*integrations.IntegrationsDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integrations", integrationId},
	}
