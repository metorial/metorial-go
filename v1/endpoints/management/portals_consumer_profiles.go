...
func (e *PortalsConsumerProfilesEndpoint) List(instanceId string, portalId string, params *PortalsConsumerProfilesEndpointListParams) (*consumerprofiles.PortalsConsumerProfilesListOutput, error) {
...
func (e *PortalsConsumerProfilesEndpoint) Get(instanceId string, portalId string, consumerProfileId string) (*consumerprofiles.PortalsConsumerProfilesGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "portals", portalId, "consumer-profile", consumerProfileId},
	}
...
func (e *PortalsConsumerProfilesEndpoint) AssignGroups(instanceId string, portalId string, consumerProfileId string, body *PortalsConsumerProfilesEndpointAssignGroupsBody) (*consumerprofiles.PortalsConsumerProfilesAssignGroupsOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "portals", portalId, "consumer-profile", consumerProfileId, "assign-groups"},
		Body: body,
	}
...
func (e *PortalsConsumerProfilesEndpoint) UnassignGroups(instanceId string, portalId string, consumerProfileId string, body *PortalsConsumerProfilesEndpointUnassignGroupsBody) (*consumerprofiles.PortalsConsumerProfilesUnassignGroupsOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "portals", portalId, "consumer-profile", consumerProfileId, "unassign-groups"},
		Body: body,
	}
