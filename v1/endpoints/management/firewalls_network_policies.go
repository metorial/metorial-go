...
func (e *FirewallsNetworkPoliciesEndpoint) Attach(instanceId string, firewallId string, body *FirewallsNetworkPoliciesEndpointAttachBody) (*networkpolicies.FirewallsNetworkPoliciesAttachOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "firewalls", firewallId, "network-policies"},
		Body: body,
	}
...
func (e *FirewallsNetworkPoliciesEndpoint) Detach(instanceId string, firewallId string, networkPolicyId string) (*networkpolicies.FirewallsNetworkPoliciesDetachOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "firewalls", firewallId, "network-policies", networkPolicyId},
	}
