...
func (e *IntegrationsInstancesEndpoint) List(instanceId string, params *IntegrationsInstancesEndpointListParams) (*instances.IntegrationsInstancesListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "integration-instances"},
		Query: query,
	}
...
func (e *IntegrationsInstancesEndpoint) Get(instanceId string, integrationInstanceId string) (*instances.IntegrationsInstancesGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instances", integrationInstanceId},
	}
...
func (e *IntegrationsInstancesEndpoint) CreateSessionTemplate(instanceId string, integrationInstanceId string, body *IntegrationsInstancesEndpointCreateSessionTemplateBody) (*instances.IntegrationsInstancesCreateSessionTemplateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instances", integrationInstanceId, "session-template"},
		Body: body,
	}
...
func (e *IntegrationsInstancesEndpoint) CreateSession(instanceId string, integrationInstanceId string, body *IntegrationsInstancesEndpointCreateSessionBody) (*instances.IntegrationsInstancesCreateSessionOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instances", integrationInstanceId, "session"},
		Body: body,
	}
...
func (e *IntegrationsInstancesEndpoint) Create(instanceId string, body *IntegrationsInstancesEndpointCreateBody) (*instances.IntegrationsInstancesCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instances"},
		Body: body,
	}
...
func (e *IntegrationsInstancesEndpoint) Update(instanceId string, integrationInstanceId string, body *IntegrationsInstancesEndpointUpdateBody) (*instances.IntegrationsInstancesUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instances", integrationInstanceId},
		Body: body,
	}
...
func (e *IntegrationsInstancesEndpoint) Delete(instanceId string, integrationInstanceId string) (*instances.IntegrationsInstancesDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instances", integrationInstanceId},
	}
