...
func (e *ConversationsEndpoint) List(instanceId string, params *ConversationsEndpointListParams) (*conversations.ConversationsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "conversations"},
		Query: query,
	}
...
func (e *ConversationsEndpoint) Create(instanceId string, body *ConversationsEndpointCreateBody) (*conversations.ConversationsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "conversations"},
		Body: body,
	}
...
func (e *ConversationsEndpoint) Get(instanceId string, assistantConversationId string) (*conversations.ConversationsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "conversations", assistantConversationId},
	}
...
func (e *ConversationsEndpoint) Update(instanceId string, assistantConversationId string, body *ConversationsEndpointUpdateBody) (*conversations.ConversationsUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "conversations", assistantConversationId},
		Body: body,
	}
