...
func (e *SkillsGroupsEndpoint) List(instanceId string, params *SkillsGroupsEndpointListParams) (*groups.SkillsGroupsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "skill-groups"},
		Query: query,
	}
...
func (e *SkillsGroupsEndpoint) Get(instanceId string, skillGroupId string) (*groups.SkillsGroupsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "skill-groups", skillGroupId},
	}
...
func (e *SkillsGroupsEndpoint) Create(instanceId string, body *SkillsGroupsEndpointCreateBody) (*groups.SkillsGroupsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "skill-groups"},
		Body: body,
	}
...
func (e *SkillsGroupsEndpoint) Update(instanceId string, skillGroupId string, body *SkillsGroupsEndpointUpdateBody) (*groups.SkillsGroupsUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "skill-groups", skillGroupId},
		Body: body,
	}
...
func (e *SkillsGroupsEndpoint) Delete(instanceId string, skillGroupId string) (*groups.SkillsGroupsDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "skill-groups", skillGroupId},
	}
