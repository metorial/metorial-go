...
func (e *PortalsConsumerInvitesEndpoint) List(instanceId string, portalId string, params *PortalsConsumerInvitesEndpointListParams) (*consumerinvites.PortalsConsumerInvitesListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "portals", portalId, "consumer-invites"},
		Query: query,
	}
...
func (e *PortalsConsumerInvitesEndpoint) Create(instanceId string, portalId string, body *PortalsConsumerInvitesEndpointCreateBody) (*consumerinvites.PortalsConsumerInvitesCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "portals", portalId, "consumer-invites"},
		Body: body,
	}
...
func (e *PortalsConsumerInvitesEndpoint) Get(instanceId string, portalId string, consumerInviteId string) (*consumerinvites.PortalsConsumerInvitesGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "portals", portalId, "consumer-invites", consumerInviteId},
	}
