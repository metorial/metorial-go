...
func (e *ProviderToolsEndpoint) List(instanceId string, params *ProviderToolsEndpointListParams) (*tools.ProviderToolsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "provider-tools"},
		Query: query,
	}
...
func (e *ProviderToolsEndpoint) Get(instanceId string, providerToolId string) (*tools.ProviderToolsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "provider-tools", providerToolId},
	}
