...
func (e *SkillsItemsEndpoint) List(instanceId string, skillId string, params *SkillsItemsEndpointListParams) (*items.SkillsItemsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "skills", skillId, "items"},
		Query: query,
	}
...
func (e *SkillsItemsEndpoint) Get(instanceId string, skillId string, skillItemId string) (*items.SkillsItemsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "skills", skillId, "items", skillItemId},
	}
...
func (e *SkillsItemsEndpoint) Create(instanceId string, skillId string) (*items.SkillsItemsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "skills", skillId, "items"},
	}
...
func (e *SkillsItemsEndpoint) Delete(instanceId string, skillId string, skillItemId string) (*items.SkillsItemsDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "skills", skillId, "items", skillItemId},
	}
