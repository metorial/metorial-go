...
func (e *FirewallBindingsEndpoint) List(instanceId string, params *FirewallBindingsEndpointListParams) (*firewallbindings.FirewallBindingsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "firewall-bindings"},
		Query: query,
	}
...
func (e *FirewallBindingsEndpoint) Get(instanceId string, firewallBindingId string) (*firewallbindings.FirewallBindingsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "firewall-bindings", firewallBindingId},
	}
...
func (e *FirewallBindingsEndpoint) Create(instanceId string, body *FirewallBindingsEndpointCreateBody) (*firewallbindings.FirewallBindingsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "firewall-bindings"},
		Body: body,
	}
...
func (e *FirewallBindingsEndpoint) Delete(instanceId string, firewallBindingId string) (*firewallbindings.FirewallBindingsDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "firewall-bindings", firewallBindingId},
	}
