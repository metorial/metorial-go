...
func (e *StoresParticipantsEndpoint) List(instanceId string, storeId string, params *StoresParticipantsEndpointListParams) (*participants.StoresParticipantsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "stores", storeId, "participants"},
		Query: query,
	}
...
func (e *StoresParticipantsEndpoint) Get(instanceId string, storeId string, storeParticipantId string) (*participants.StoresParticipantsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "stores", storeId, "participants", storeParticipantId},
	}
