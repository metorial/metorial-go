...
func (e *MagicMcpServersProviderEndpoint) List(instanceId string, magicMcpServerId string, params *MagicMcpServersProviderEndpointListParams) (*provider.MagicMcpServersProviderListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "magic-mcp-servers", magicMcpServerId, "provider"},
		Query: query,
	}
...
func (e *MagicMcpServersProviderEndpoint) Get(instanceId string, magicMcpServerId string, magicMcpServerProviderId string) (*provider.MagicMcpServersProviderGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "magic-mcp-servers", magicMcpServerId, "provider", magicMcpServerProviderId},
	}
...
func (e *MagicMcpServersProviderEndpoint) Create(instanceId string, magicMcpServerId string, body *MagicMcpServersProviderEndpointCreateBody) (*provider.MagicMcpServersProviderCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "magic-mcp-servers", magicMcpServerId, "provider"},
		Body: body,
	}
...
func (e *MagicMcpServersProviderEndpoint) Update(instanceId string, magicMcpServerId string, magicMcpServerProviderId string, body *MagicMcpServersProviderEndpointUpdateBody) (*provider.MagicMcpServersProviderUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "magic-mcp-servers", magicMcpServerId, "provider", magicMcpServerProviderId},
		Body: body,
	}
...
func (e *MagicMcpServersProviderEndpoint) Delete(instanceId string, magicMcpServerId string, magicMcpServerProviderId string) (*provider.MagicMcpServersProviderDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "magic-mcp-servers", magicMcpServerId, "provider", magicMcpServerProviderId},
	}
