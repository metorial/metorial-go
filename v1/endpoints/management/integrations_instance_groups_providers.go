...
func (e *IntegrationsInstanceGroupsProvidersEndpoint) List(instanceId string, params *IntegrationsInstanceGroupsProvidersEndpointListParams) (*providers.IntegrationsInstanceGroupsProvidersListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "integration-instance-group-providers"},
		Query: query,
	}
...
func (e *IntegrationsInstanceGroupsProvidersEndpoint) Get(instanceId string, integrationInstanceGroupProviderId string) (*providers.IntegrationsInstanceGroupsProvidersGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instance-group-providers", integrationInstanceGroupProviderId},
	}
...
func (e *IntegrationsInstanceGroupsProvidersEndpoint) Set(instanceId string, integrationInstanceGroupId string, integrationInstanceProviderId string, body *IntegrationsInstanceGroupsProvidersEndpointSetBody) (*providers.IntegrationsInstanceGroupsProvidersSetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instance-groups", integrationInstanceGroupId, "providers", integrationInstanceProviderId},
		Body: body,
	}
...
func (e *IntegrationsInstanceGroupsProvidersEndpoint) Delete(instanceId string, integrationInstanceGroupProviderId string) (*providers.IntegrationsInstanceGroupsProvidersDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "integration-instance-group-providers", integrationInstanceGroupProviderId},
	}
