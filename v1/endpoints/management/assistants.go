...
func (e *AssistantsEndpoint) List(instanceId string, params *AssistantsEndpointListParams) (*assistants.AssistantsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "assistants"},
		Query: query,
	}
...
func (e *AssistantsEndpoint) Get(instanceId string, assistantId string) (*assistants.AssistantsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "assistants", assistantId},
	}
