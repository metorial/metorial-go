...
func (e *PortalsAuthSsoTenantsEndpoint) List(portalId string, params *PortalsAuthSsoTenantsEndpointListParams) (*ssotenants.PortalsAuthSsoTenantsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"portals", portalId, "auth", "sso-tenants"},
		Query: query,
	}
...
func (e *PortalsAuthSsoTenantsEndpoint) Create(portalId string, body *PortalsAuthSsoTenantsEndpointCreateBody) (*ssotenants.PortalsAuthSsoTenantsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"portals", portalId, "auth", "sso-tenants"},
		Body: body,
	}
...
func (e *PortalsAuthSsoTenantsEndpoint) Setup(portalId string, ssoTenantId string) (*ssotenants.PortalsAuthSsoTenantsSetupOutput, error) {
	req := &endpoint.Request{
		Path: []string{"portals", portalId, "auth", "sso-tenants", ssoTenantId, "setup"},
	}
