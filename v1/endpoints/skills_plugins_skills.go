...
func (e *SkillsPluginsSkillsEndpoint) List(skillPluginId string, params *SkillsPluginsSkillsEndpointListParams) (*skills.SkillsPluginsSkillsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"skill-plugins", skillPluginId, "skills"},
		Query: query,
	}
...
func (e *SkillsPluginsSkillsEndpoint) Get(skillPluginId string, skillPluginSkillId string) (*skills.SkillsPluginsSkillsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"skill-plugins", skillPluginId, "skills", skillPluginSkillId},
	}
...
func (e *SkillsPluginsSkillsEndpoint) Update(skillPluginId string, skillPluginSkillId string, body *SkillsPluginsSkillsEndpointUpdateBody) (*skills.SkillsPluginsSkillsUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"skill-plugins", skillPluginId, "skills", skillPluginSkillId},
		Body: body,
	}
...
func (e *SkillsPluginsSkillsEndpoint) Remove(skillPluginId string, skillPluginSkillId string) (*skills.SkillsPluginsSkillsRemoveOutput, error) {
	req := &endpoint.Request{
		Path: []string{"skill-plugins", skillPluginId, "skills", skillPluginSkillId},
	}
