...
func (e *PortalsAuthAppEndpoint) Get(portalId string) (*app.PortalsAuthAppGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"portals", portalId, "auth", "app"},
	}
...
func (e *PortalsAuthAppEndpoint) Update(portalId string, body *PortalsAuthAppEndpointUpdateBody) (*app.PortalsAuthAppUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"portals", portalId, "auth", "app"},
		Body: body,
	}
