...
func (e *SkillsExportsEndpoint) List(params *SkillsExportsEndpointListParams) (*exports.SkillsExportsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"skill-exports"},
		Query: query,
	}
...
func (e *SkillsExportsEndpoint) Get(skillExportId string) (*exports.SkillsExportsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"skill-exports", skillExportId},
	}
...
func (e *SkillsExportsEndpoint) Create(body *SkillsExportsEndpointCreateBody) (*exports.SkillsExportsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"skill-exports"},
		Body: body,
	}
