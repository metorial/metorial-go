...
func (e *DocumentsParticipantsEndpoint) List(documentId string, params *DocumentsParticipantsEndpointListParams) (*participants.DocumentsParticipantsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"documents", documentId, "participants"},
		Query: query,
	}
...
func (e *DocumentsParticipantsEndpoint) Get(documentId string, documentParticipantId string) (*participants.DocumentsParticipantsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"documents", documentId, "participants", documentParticipantId},
	}
