...
func (e *PortalsAccessRequestsEndpoint) List(portalId string, params *PortalsAccessRequestsEndpointListParams) (*accessrequests.PortalsAccessRequestsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"portals", portalId, "access-requests"},
		Query: query,
	}
...
func (e *PortalsAccessRequestsEndpoint) Get(portalId string, accessRequestId string) (*accessrequests.PortalsAccessRequestsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"portals", portalId, "access-requests", accessRequestId},
	}
...
func (e *PortalsAccessRequestsEndpoint) Update(portalId string, accessRequestId string, body *PortalsAccessRequestsEndpointUpdateBody) (*accessrequests.PortalsAccessRequestsUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"portals", portalId, "access-requests", accessRequestId},
		Body: body,
	}
